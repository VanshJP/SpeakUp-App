                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                ...
                                .concepts(title: "What to expect", body: "Most people score between 40-60 on their first recording. That's completely normal. After completing this learning path, the average improvement is 20-30 points."),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .concepts(title: "Speaking pace explained", body: "A useful conversational default is around 150 words per minute (WPM), with room on either side.\nWell below your target can feel slow and cause listeners to drift. Well above it makes ideas hard to follow.\nPace naturally varies. You might speed up when excited and slow down for emphasis. That variation is useful when you choose it on purpose.\nBig Talk scores pace against your personal target (Settings → Pace). Auto-calibration can move that target as you practice."),
                                .example(title: "Famous speakers' pace", body: "**Martin Luther King Jr.** “I Have a Dream” averaged about 100 WPM, deliberately slow for dramatic impact.\n**John F. Kennedy** His inaugural address ran about 135 WPM, measured and presidential.\n**A casual TED talk** Typically 150-170 WPM, energetic but clear."),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .concepts(title: "The science of vocal warm-ups", body: "Your vocal cords are muscles, specifically, two small folds of tissue in your larynx that vibrate to produce sound.\nCold muscles are tense and stiff. When you speak without warming up, your voice can sound tight, thin, or gravelly.\nA 2-3 minute warm-up increases blood flow to your vocal cords, relaxes surrounding muscles, and expands your pitch range.\nSingers never perform without warming up. Speakers should adopt the same habit."),
                                .concepts(title: "Your 3-minute pre-speaking routine", body: "**Breathing, 30 seconds** Three deep belly breaths to activate your diaphragm.\n**Humming, 30 seconds** Hum at a comfortable pitch, feeling the vibration in your face.\n**Tongue twisters, 60 seconds** Articulation exercises to wake up your mouth muscles.\n**Range glides, 30 seconds** Slide your voice from low to high and back to expand your range.\n**Practice sentence, 30 seconds** Say one clear sentence out loud to calibrate your volume and pace."),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .concepts(title: "The stamina challenge", body: "Most conversations happen in 15-30 second bursts. Speaking for 3 minutes straight is like running a mile after only ever doing sprints.\nThe main challenge isn't running out of words, it's running out of structure. Without a plan, you'll circle back to the same points or trail off.\nThe secret to longer talks: think in segments. A 3-minute talk is really just three 1-minute segments stitched together with transitions."),
                                .concepts(title: "The 3-block method", body: "**The first minute** Open strong and state your main idea. Use PREP or AREA to structure this.\n**The middle minute** Go deeper. Add a second example, explore a counter-argument, or share a related story.\n**The final minute** Circle back to your main idea. Summarize what you covered and end with a memorable closing line.\nStitch the blocks with a turn of phrase: “Now here's where it gets interesting…” “On the other hand…” “And that brings me to the key point…”"),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        ...
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .callout(title: "Milestone reached!", body: "You've completed the foundation phase of the Big Talk Learning Path. You now have baseline awareness, core technique, structural frameworks, and confidence tools. That's a real achievement.", icon: "trophy.fill"),
                                .concepts(title: "What you've built", body: "Each week added one layer:\n**Awareness** You know your patterns, your filler habits, and your natural pace.\n**Technique** Breathing, filler control, pace management, and warm-up routines.\n**Structure** PREP, STAR, strategic pauses, and sentence completion.\n**Confidence** Anxiety management, impromptu skills, and endurance."),
                                .concepts(title: "What's ahead", body: "The advanced path takes you from competent to compelling. You'll learn:\n**Vocal mastery** Pitch, volume, emphasis, and articulation that commands attention.\n**Advanced frameworks** Rule of Three, Problem-Solution-Benefit, and more structures for any situation.\n**Storytelling** How to open with a hook, build emotional connection, and close with impact.\n**Real-world application** Elevator pitches, Q&A handling, and full 5-minute presentations."),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .concepts(title: "The first 10 seconds", body: "Your audience decides in the first 10 seconds whether they'll pay attention or zone out. This decision is largely unconscious, it's based on whether your opening triggers curiosity.\nThe worst opening? “Hi, my name is… and today I'll be talking about…” This is the verbal equivalent of a loading screen. Your audience has already checked out.\nGreat speakers start with a hook, something that grabs attention and creates a reason to keep listening."),
                                .concepts(title: "Seven hooks that work", body: "**The Question** Ask something that makes them think. “What would you do if you had 24 hours to live?”\n**The Surprising Fact** Lead with something unexpected. “You spend 93% of your life indoors.”\n**The Bold Statement** Say something provocative. “Everything you know about productivity is wrong.”\n**The Story** Drop them into a scene. “I was standing at the edge of a cliff when my phone rang.”\n**The Quotation** Use a powerful quote, then react to it.\n**The Imagine Prompt** Put them inside the picture. “Imagine waking up tomorrow and your biggest fear is gone.”\n**The Callback** Reference something the audience just experienced. “Five minutes ago, every one of you checked your phone.”"),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .concepts(title: "Why closings matter", body: "The Peak-End Rule in psychology says people judge an experience based on the most intense moment and the ending, not the average.\nThis means your closing has disproportionate power over how your audience remembers your entire talk.\nThe worst closing? “So, yeah… that's pretty much it.” “Um, I think that's all I have.” “Any questions?” These endings dissolve everything you've built."),
                                .concepts(title: "Six powerful closing techniques", body: "**The Callback** Reference your opening hook. This creates a satisfying loop.\n**The Challenge** Call your audience to action. “Starting tomorrow, I challenge you to…”\n**The Powerful Quote** End with words more eloquent than your own. Let the quote resonate.\n**The Three-Word Phrase** Distill your message into a mantra. “Start. Today. Now.”\n**The Story Resolution** If you opened with a story, finish it in the closing.\n**The Vision** Paint a picture of the future if they act on your message."),
                ...
                CurriculumLesson(
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                .concepts(title: "The 5-minute talk blueprint", body: "Five minutes is the gold standard for short-form speaking. It's long enough to be substantive but short enough to hold full attention. TED recommends 5-18 minutes for a reason.\nThis is your capstone, every skill from the past 8 weeks comes together here.\nThink of it as five 1-minute blocks, each with a clear purpose."),
                                .concepts(title: "The five blocks", body: "**The hook and big idea, 0:00-1:00** Open with a hook (week 7), then state your one big idea clearly. Everything else supports this single thesis.\n**The problem or context, 1:00-2:00** Set up the tension using PSB or What-So What-Now What.\n**The core argument, 2:00-3:30** Your main evidence, using the Rule of Three. Three points, each with a brief example.\n**The story, 3:30-4:30** A personal story that illustrates your big idea. Use the story arc for structure.\n**The close, 4:30-5:00** Restate your big idea, deliver a challenge or vision, and end with your strongest line."),
                                .example(title: "Transitions between blocks", body: "**Hook → problem** “Here's why this matters…”\n**Problem → argument** “Let me show you the three reasons…”\n**Argument → story** “Let me tell you a story that brings this to life…”\n**Story → close** “And that brings me to the one thing I hope you take away…”\nSmooth transitions are the glue that holds your talk together. Without them, your talk feels like a list."),
                    ...
                    activities: [
                        .lesson(
                            ...
                            content: LessonContent(sections: [
                                ...
                                .example(title: "Follow-ups in action", body: "**They say** “I went hiking last weekend.”\n**Bad follow-up** “Oh cool, I also like hiking.”\n**Good follow-up** “What's the best trail you've done recently? What made it special?”\nThe good one stays in their world before entering yours."),
                                .concepts(title: "Active listening signals", body: "**Verbal cues** Short prompts: “That's interesting,” “Tell me more,” “What happened next?”\n**Non-verbal cues** Nodding, eye contact, leaning in slightly.\n**Reflection** Paraphrase what they said. “So you basically rebuilt the whole thing from scratch? That must have been intense.”\nThese signals tell the other person you're genuinely engaged, not just waiting for your turn."),
